<?php
  ...
  $sql="SELECT id FROM category_table WHERE username='$uname' and category='others';";
  $result=mysqli_query($db,$sql);
  $row=mysqli_fetch_array($result,MYSQLI_ASSOC);
  $count = mysqli_num_rows($result);
  if($count == 1)
    {
      header("location:updateother.php");
    }
    else
    {
  ...
  if(isset($_POST['field1']))
  {
    ...
    $query = mysqli_query($db, "INSERT INTO category_table (username,category, field1, field2,field3,field4,field5,field6,field7,field8,field9,field10) VALUES ('$uname','others','$field1','$field2','$field3','$field4','$field5','$field6','$field7','$field8','$field9','$field10')");
...
<body>
  ...
  transition: all 0.60s;">
        ...
        <div class="container-fluid" style="margin-top: 5%;    margin-left: 10%;">
          <h2 style="text-align: center;font-family: 'Capriola', sans-serif;margin-left: 5%">Fill Your Other Category Bucket</h2>
          <hr class="customhr">
