<?php
  ...
  $sql="SELECT id FROM category_table WHERE username='$uname' and category='travelling';";
  $result=mysqli_query($db,$sql);
  $row=mysqli_fetch_array($result,MYSQLI_ASSOC);
  $count = mysqli_num_rows($result);
  if($count == 1)
    {
      header("location:updatetravell.php");
    }
  else
  {
  @$field1="";
  ...
  if(isset($_POST['field1']))
  {
    ...
    $query = mysqli_query($db, "INSERT INTO category_table (username,category, field1, field2,field3,field4,field5,field6,field7,field8,field9,field10) VALUES ('$uname','travelling', '$field1', '$field2','$field3','$field4','$field5','$field6','$field7','$field8','$field9','$field10')");
